<script>
	export let onButtonClickHandler = null;
</script>
				...
				<div class="sm:flex sm:items-start">
					...
					<div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left flex-1">
						<h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
							<slot name="modal-title">Oops! That's an error. 💥</slot>
						</h3>
						<div class="mt-2 max-w-full px-4 text-sm text-left text-gray-500">
							<slot name="modal-body">
								<p class="">Something went wrong! Please try again...</p>
							</slot>
						</div>
					</div>
				</div>
